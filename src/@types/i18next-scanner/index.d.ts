...
declare module 'i18next-scanner' {
    ...
    export class Parser {
        ...
        public parseFuncFromString(content: string, opts: I18NextScannerOptions, customHandler?: (key: string) => void): Parser;

        public parseTransFromString(content: string, customHandler?: (key: string) => void): Parser;
        public parseTransFromString(content: string, opts: I18NextScannerOptions, customHandler?: (key: string) => void): Parser;

        public parseAttrFromString(content: string, customHandler?: (key: string) => void): Parser;
        public parseAttrFromString(content: string, opts: I18NextScannerOptions, customHandler?: (key: string) => void): Parser;

        public get(opts?: I18NextScannerOptions): {[language: string]: {[ ns: string]: {[key: string]: string }}};
